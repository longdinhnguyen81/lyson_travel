	  ...
	  <div class="container-fluid">
	    <div class="quick-actions_homepage">
	        <ul class="quick-actions">
		        <li class="bg_lr"> <a href="{{route('admin.tag.index')}}"> <i class="icon-dashboard"></i> Tag</a> </li>
		        <li class="bg_ly"> <a href="{{route('admin.news.index')}}"> <i class="icon-inbox"></i>Tin tức</a> </li>
		        <li class="bg_lv"> <a href="{{route('admin.news.index')}}"> <i class="icon-inbox"></i>Stick</a> </li>
		        <li class="bg_ls"> <a href="{{route('admin.tour.index')}}"> <i class="icon-fullscreen"></i>Tour du lịch</a> </li>
