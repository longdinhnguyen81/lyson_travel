	          ...
	          <div class="widget-content nopadding">
	            ...
	            <div class="control-group">
	              ...
	              <div class="control-group">
                      ...
                      <div class="controls">
                        <select name="hotel">
                          <option selected value="Khách Sạn">Khách sạn Mường Thanh</option>
                          <option value="Nhà Nghỉ">Lý Trí</option>
                        </select>
                     </div>
                  </div>
	              <div class="control-group">
	              ...
	              <div class="control-group">
	                <label class="control-label">Xuất phát từ:</label>
	                <div class="controls">
	                  <input type="text" name="from" id="required" value="{{ old('from') }}" style="width: 70%" />
	                </div>
	              </div>
	              <div class="control-group">
